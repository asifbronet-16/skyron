...
//       <nav className="mx-auto flex max-w-350 items-center justify-between px-6 py-7 lg:px-12">
//         {/* Logo */}
...
//           >
//             <span className="block rounded-full bg-[#08060f] px-7 py-2.5 text-sm font-medium text-white">
//               Contact
//             </span>
//           </Link>
//         </div>
...
//         >
//           <span
//             className={`h-px w-6 bg-white transition-transform ${open ? "translate-y-1.75 rotate-45" : ""
//               }`}
//           />
//           <span
//             className={`h-px w-6 bg-white transition-opacity ${open ? "opacity-0" : ""
//               }`}
//           />
//           <span
//             className={`h-px w-6 bg-white transition-transform ${open ? "-translate-y-1.75 -rotate-45" : ""
